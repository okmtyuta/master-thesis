...
\begin{align}
  ...
  \end{dcases}
\end{align}
where $\theta, \theta^\prime \in \Theta$ are parameters of the reaction term. We impose periodic boundary conditions on $\Omega$. We also denote by $U = \left( u_1, \dots, u_n \right)$ and $U^\prime = \left( u_1^\prime, \dots, u_n^\prime \right)$ the vector-valued solutions of \eqref{eq:reaction-diffusion-equations-normal} and \eqref{eq:reaction-diffusion-equations-prime}, respectively.
...
\begin{proof}
  This is obvious at $t = 0$. For any $0 < t \leq T$ and $x \in \mathbb{R}^d$
  \begin{align*}
  ...
  \begin{align*}
    ...
    &= \dfrac{d}{\lambda}
  \end{align*}
  Thus, \eqref{eq:lem-heat-kernel-lip-1} is proved.
